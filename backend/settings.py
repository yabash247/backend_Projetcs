...
EMAIL_HOST_USER = 'yabashllc@gmail.com'
EMAIL_HOST_PASSWORD = 'pvub pwrl xnot jkec'
...
# Add custom user model later if needed
AUTH_USER_MODEL = 'users.User'  # Optional: If you're extending User model
...
SIMPLE_JWT = {
    ...
    'ALGORITHM': 'HS256',
    'SIGNING_KEY': SECRET_KEY,  # Assuming SECRET_KEY is defined elsewhere in your settings
    'VERIFYING_KEY': None,
...
# Optional settings for 2FA
TWO_FACTOR_REMEMBER_COOKIE_AGE = 1209600  # 2 weeks
